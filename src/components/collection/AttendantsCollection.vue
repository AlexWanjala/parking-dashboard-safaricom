        ...
        <div class="row">
          <div class="col-md-8 col-sm-12">
                        <span class="rev-title-container">
                                 <h1 class="text-capitalize stream_name m-0">Attendants Collection</h1>
                                </span>
            <div class="">
              <ol class="breadcrumb border-0">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item"><a href="index.html">Collection</a></li>
                <li class="breadcrumb-item active">Attendants Collection</li>
              </ol>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped mb-0">
                  ...
                  <tr>
                    ...
                    <td class=""></td>
                    <td>
                      <a href="#" class="btn btn-primary btn-sm btn--icon-text d-none"><i class="zmdi zmdi-eye mr-2"></i>View Details</a>
                    </td>
                  </tr>
