        ...
        <div class="row">
          <div class="col-md-8 col-sm-12">
                        <span class="rev-title-container">
                                 <h1 class="text-capitalize stream_name m-0">Street Report</h1>
                                </span>
            <div class="">
              <ol class="breadcrumb border-0">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item"><a href="index.html">Reports</a></li>
                <li class="breadcrumb-item active">Street Report</li>
              </ol>
            </div>
          </div>
                ...
                <table class="table table-striped mb-0">
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">#2 Sotik Road, Off Bunyala Road, Nairobi 00100, Bunyala Rd, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                    <td class="text-capitalize">25</td>
                    <td class="text-capitalize">15</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">00100, 17402, CHESTER HOUSE, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">00100, 49062, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">00200 Biashara St, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">02 Koinange St, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">03 Dar Es Salaam Rd, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">03 Koinange St, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">03 Westlands Rd, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">10 Bamburi Rd, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">1 Munyu Rd, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="#">1 Kijabe St, Nairobi, Kenya</a>
                    </td>
                    <td class="text-capitalize">126061</td>
                    <td class="text-capitalize">100</td>
                    <td class="text-capitalize">40</td>
