  ...
  <main class="main">
    ...
    <section class="content parking_body custom-table-container content content--full">
      <header class="content__title px-0 border-0">
        <div class="row">
          <div class="col-md-8 col-sm-12"><span class="rev-title-container"><h1 class="text-capitalize stream_name m-0">Revenue Officer Report</h1>
							</span>
            <div class="">
              <ol class="breadcrumb border-0">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item"><a href="index.html">Reports</a></li>
                <li class="breadcrumb-item active">Revenue Officer Report</li>
              </ol>
            </div>
          </div>
                ...
                <table class="table table-striped mb-0" id="data-table">
                  ...
                  <tr>
                    ...
                    <td class="text-capitalize">
                      <a href="IndividualAttendantReport.html">Mtu Mzuri Sana</a>
                    </td>
